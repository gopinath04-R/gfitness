...
export default function BMICalculator() {
  ...
  return (
    <section id="bmi" style={{ padding: '6rem 1.5rem', maxWidth: '580px', margin: '0 auto', position: 'relative' }}>
      <style>{`
        @keyframes fadeUp { from{opacity:0;transform:translateY(30px)} to{opacity:1;transform:translateY(0)} }
        @keyframes burst { 0%{transform:translate(-50%,-50%) rotate(var(--angle)) translateY(0) scale(1);opacity:1} 100%{transform:translate(-50%,-50%) rotate(var(--angle)) translateY(-60px) scale(0);opacity:0} }
        @keyframes glow { 0%,100%{box-shadow:0 0 20px var(--c)} 50%{box-shadow:0 0 40px var(--c), 0 0 80px var(--c)} }
        ...
        .range-card:hover{transform:translateY(-2px);border-color:var(--rc)!important;}
      `}</style>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: '50%', animation: 'glow 1.5s infinite',
            '--c': '#39ff14'
          }}/>
        ...
        <p style={{ color: '#333', fontSize: '0.85rem', fontFamily: 'Orbitron', letterSpacing: '1px' }}>
      ...
      <div style={{
        ...
        boxShadow: '0 30px 80px rgba(0,0,0,0.6), inset 0 1px 0 #ffffff08'
      }}>
        {/* Corner glows */}
        ...
        <div style={{ position:'absolute', bottom:'-60px', left:'-60px', width:'180px', height:'180px', background:'radial-gradient(circle, #39ff1408 0%, transparent 70%)', borderRadius:'50%', pointerEvents:'none' }}/>
        ...
        <button className="calc-btn" onClick={calculate} style={{
          ...
          boxShadow: '0 4px 25px #39ff1444, inset 0 1px 0 #ffffff44'
          ...
          <div style={{ marginTop: '2rem', animation: 'fadeUp 0.6s ease' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: `radial-gradient(ellipse at 50% 0%, ${result.color}0a, transparent 60%)`,
                pointerEvents: 'none'
              }}/>
              ...
              <div style={{ color: '#444', fontSize: '0.8rem', marginTop: '1rem', lineHeight: 1.6 }}>
                {result.advice}
              </div>
            </div>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                <span style={{ color: '#222', fontSize: '0.6rem', fontFamily: 'Orbitron' }}>10 — Underweight</span>
                <span style={{ color: '#222', fontSize: '0.6rem', fontFamily: 'Orbitron' }}>40+ — Obese</span>
              </div>
              <div style={{ height: '12px', background: '#0a0a0a', borderRadius: '12px', overflow: 'hidden', border: '1px solid #1a1a1a', position: 'relative' }}>
                {/* gradient track */}
                <div style={{
                  position: 'absolute', inset: 0,
                  background: 'linear-gradient(90deg, #00d4ff 0%, #39ff14 30%, #ffd700 65%, #ff4444 100%)',
                  opacity: 0.2
                }}/>
                <div style={{
                  ...
                  borderRadius: '12px',
                  boxShadow: `0 0 15px ${result.color}88`,
              ...
              <div style={{ position: 'relative', marginTop: '4px' }}>
                <div style={{
                  ...
                  color: result.color, fontFamily: 'Orbitron', fontSize: '0.65rem'
                }}>▲ {result.bmi}</div>
              </div>
            </div>
            ...
            {idealWeight && (
              <div style={{
                ...
                <div>
                  <div style={{ color: '#39ff14', fontFamily: 'Orbitron', fontSize: '0.7rem', letterSpacing: '1px' }}>IDEAL WEIGHT RANGE</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem' }}>
              {[
                ...
                <div key={item.label} className="range-card"
                  style={{
                    ...
                    '--rc': item.c,
                    boxShadow: result.label === item.label.toUpperCase() ? `0 4px 20px ${item.c}22` : 'none'
                  }}>
